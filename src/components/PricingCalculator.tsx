...
export default function PricingCalculator() {
  ...
  const billableDays = Math.max(0, days - 2);
      ...
      <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row items-start md:items-end justify-between gap-6">
        <div className="space-y-1 text-sm">
          <div className="flex gap-6 text-gray-500">
            ...
            <span className="text-brand-black font-medium">${drop}</span>
          </div>
          <div className="flex gap-6 text-gray-500">
            <span>
              {billableDays === 0
            ...
            <span className="text-brand-black font-medium">${daily * billableDays}</span>
          </div>
